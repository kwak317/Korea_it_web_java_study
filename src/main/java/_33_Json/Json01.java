...
//본래 자바스크립트 언어로 파생된 자바스크립트 구문을 따르지만, 언어 독립형 데이터 포맷
//Map 형태처럼 키 값 형태

//Gson
//Google Json의 약자로 Java객체를 Jason형태로 변환하거나 혹은 반대로 변환하는데 사용
//주요 클래스
...
public class Json01 {
    public static void main(String[] args) {
        ...
        String jason1 = gson1.toJson(jsonObject1);

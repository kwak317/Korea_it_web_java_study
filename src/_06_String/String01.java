...
public class String01 {
    public static void main(String[] args) {
        String str = "My name is Hojun Kwak";
        ...
        System.out.println(str.indexOf("age")); //만약 없으면 -1을 출력

        str = "I like music and movie and travel";
        System.out.println(str.lastIndexOf("and")); //여러개 중에서 마지막 위치
        System.out.println(str.lastIndexOf("java")); //없으면 마찬가지로 -1을 반환
        System.out.println(str.startsWith("I like")); //해당 문자열로 시작하냐? => 결과는 boolean
